...
## Step Taken Before the Simulation 
  ...
  - I created two users for the simulation in Microsoft 365 admin center.
  ...
  - After completing the lab, I created a Conditional Access policy to block cloud app access from the country Japan in order to test whether the policy was functioning correctly in Micrsoft Entra ID . As shown in the screenshot, the policy is working as expected.
